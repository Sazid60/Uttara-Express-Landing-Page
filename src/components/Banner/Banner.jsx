...
const Banner = () => {
    return (
        <>
            {/* Hero Section */}
            <div className="relative bg-[url('/assets/Banner.jpg')] bg-cover bg-center w-full min-h-[600px] md:min-h-[800px] lg:min-h-[900px] xl:lg:min-h-[700px] flex justify-center items-center px-4">
                {/* Overlay */}
                <div className="absolute inset-0 bg-black opacity-60 z-0"></div>
                <div className="text-white text-center px-4 relative z-10 mt-20 md:mt-10">
                    <div className="max-w-7xl mx-auto">
                        <h1 className="text-3xl md:text-7xl font-bold mb-8 leading-tight uppercase">
